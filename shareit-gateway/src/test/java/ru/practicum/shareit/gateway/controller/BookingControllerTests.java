...
class BookingControllerTests {
    ...
    // Тесты из BookingControllerGatewayTest
    @Test
    ...
    @Test
    void updateBookingStatus_WithoutApprovedParam_ReturnsBadRequest() throws Exception {
        mockMvc.perform(patch("/bookings/1")
                        .header("X-Sharer-User-Id", 1L))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getUserBookings_WithInvalidState_ReturnsOk() throws Exception {
    ...
    @Test
    void getUserBookings_WithNegativeFrom_ReturnsBadRequest() throws Exception {
        mockMvc.perform(get("/bookings")
                        .header("X-Sharer-User-Id", 1L)
                        .param("from", "-1"))
                .andExpect(status().isBadRequest());
    ...
    @Test
    void getUserBookings_WithZeroSize_ReturnsBadRequest() throws Exception {
        mockMvc.perform(get("/bookings")
                        .header("X-Sharer-User-Id", 1L)
                        .param("size", "0"))
                .andExpect(status().isBadRequest());
    ...
    @Test
    void getOwnerBookings_WithInvalidParams_ReturnsBadRequest() throws Exception {
        mockMvc.perform(get("/bookings/owner")
                        .header("X-Sharer-User-Id", 1L)
                        .param("from", "-5")
                        .param("size", "0"))
    ...
    @Test
    void createBooking_WithNullDates_ReturnsBadRequest() throws Exception {
        String invalidJson = """
            {
                "itemId": 1
            }
