...
class ItemOwnerDtoTest {
    ...
    void testEqualsAndHashCode() {
        ...
        ItemOwnerDto dto1 = new ItemOwnerDto(1L, "Hammer", "Desc", true, 100L,
                lastBooking, nextBooking, comments);
        ItemOwnerDto dto2 = new ItemOwnerDto(1L, "Hammer", "Desc", true, 100L,
                lastBooking, nextBooking, comments);
        ItemOwnerDto dto3 = new ItemOwnerDto(2L, "Drill", "Desc2", false, 200L,
                lastBooking, nextBooking, comments);
